...
def main():
    ...
    stakeholder5.agregar_recomendacion(stakeholder1)
    stakeholder4.agregar_recomendacion(stakeholder1)
    ...
    solucion_optima = algoritmo_greedy([requisito1, requisito2, requisito3, requisito4, requisito5], limite_coste)
